"""
Django settings for RayoMakween project.
...
SECRET_KEY = 'django-insecure-jx$(478(*h&&p4p#3#z+z52^mti46ph9m-v)!z8v)r8m*5lbkb'
...
AUTH_USER_MODEL = 'AppPrincipal.User'
...
WSGI_APPLICATION = 'RayoMakween.wsgi.application'
